...
import { Github, Linkedin, Twitter, Rss, Facebook } from 'lucide-react'; 
          ...
          <SidebarProvider defaultOpen={false}> {/* Sidebar hidden by default */}
            <Sidebar variant="sidebar" collapsible="icon" className="shadow-lg">
              <SidebarHeader className="p-4 items-center">
                ...
                {/* This trigger is for desktop icon mode toggle, not primarily for mobile sheet */}
            ...
            <SidebarInset>
              {/* Mobile Header */}
              <div className="md:hidden flex items-center justify-between p-4 bg-background/80 backdrop-blur-md sticky top-0 z-40 shadow-sm border-b">
                <AppLogo />
                <SidebarTrigger />
              </div>
